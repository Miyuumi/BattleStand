...
<template>
    <div>
        ...
        <div class="min-h-screen bg-gray-100">
            <nav
                class="bg-white border-b border-gray-100 h-[5%] top-0 sticky z-10"
            >
                ...
                <div class="mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between items-center h-16">
                        <div class="flex">
                            ...
                            <!-- Title -->
                            <div
                                class="hidden space-x-8 text-lg sm:-my-px sm:ms-4 sm:flex mt-1"
                            >
                                R2TMC Inventory Management System
                            </div>
                        </div>
                ...
                >
                    <v-list v-model:opened="open">
                        ...
                        <v-list-item
                            ...
                            :class="{
                                'hover:text-[#4B42FF] hover:bg-gray-50': true,
                                'v-list-item--active':
